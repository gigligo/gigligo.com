    ...
    return (
        <div className="min-h-screen bg-slate-950 px-4 py-12 flex flex-col items-center">
            ...
            <div className="w-full max-w-3xl flex gap-8">
                ...
                {(session as any)?.kycStatus === 'PENDING' ? (
                    <div className="flex-1 bg-slate-900 border border-white/10 rounded-2xl p-12 shadow-2xl flex flex-col items-center justify-center text-center">
                        <div className="w-20 h-20 bg-teal-vibrant/20 rounded-full flex items-center justify-center mb-6">
                            <CheckCircle2 className="w-10 h-10 text-teal-vibrant" />
                        </div>
                        <h2 className="text-2xl font-bold text-white mb-4">Verification in Progress</h2>
                        <p className="text-slate-400 max-w-md mx-auto">
                            We have received your identity documents. Our team is currently reviewing them. This usually takes 24-48 hours. We will notify you once the process is complete.
                        </p>
                    </div>
                ) : (
                    <>
