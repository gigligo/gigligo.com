            ...
            <div className="hidden lg:flex w-1/2 relative overflow-hidden bg-black text-white p-12 flex-col justify-between">
                ...
                >
                    ...
                    <h2 className="text-5xl font-bold leading-tight mb-6">
                        Build your <span className="text-transparent bg-clip-text bg-linear-to-r from-blue-400 to-cyan-300">legacy</span> with us.
                    </h2>
                    <p className="text-xl text-white/60 max-w-md leading-relaxed">
                        Create an account today to hire world-class talent or offer your elite services to top-tier enterprise clients.
                    </p>
                </motion.div>
