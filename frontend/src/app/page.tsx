          ...
          <div className="flex flex-col max-w-[1200px] w-full px-4 lg:px-8 gap-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[500px]">
              <div className="flex flex-col gap-8 order-2 lg:order-1">
                <div className="flex flex-col gap-4 text-left">
                  ...
                  <h1 className="text-slate-900 dark:text-white text-5xl lg:text-7xl xl:text-8xl font-black leading-[1.1] tracking-tighter">
                ...
                <div className="flex gap-4">
                  <Link
                    href="/register"
                    className="flex cursor-pointer items-center justify-center rounded-lg h-14 px-8 bg-primary text-white hover:bg-primary-dark transition-colors text-base font-bold tracking-wide shadow-xl shadow-primary/20"
                  >
                    Start Now
                  </Link>
                  <Link
                    href="/search"
                    className="flex cursor-pointer items-center justify-center rounded-lg h-14 px-8 bg-transparent border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors text-base font-medium"
                  >
                    Explore
                  </Link>
                </div>
            ...
            <div className="flex flex-col gap-16 py-24 px-8 lg:px-12 bg-[#F7F7F6] dark:bg-[#1E1E1E] rounded-[3rem] shadow-sm border border-slate-100 dark:border-slate-800">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {/* Card 1: UX Designers */}
                <Link href="/search?category=design" className="group relative flex flex-col bg-white dark:bg-[#1E1E1E] rounded-xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 border-l-4 border-transparent hover:border-primary p-2">
                  ...
                  <div className="p-6 flex flex-col flex-1 gap-4">
                    ...
                    <div className="mt-auto pt-4 border-t border-slate-100 dark:border-slate-800 flex justify-between items-center">
                      ...
                      <span className="size-10 rounded-full bg-slate-50 dark:bg-slate-800 flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-white transition-colors">
                ...
                <Link href="/search?category=development" className="group relative flex flex-col bg-white dark:bg-[#1E1E1E] rounded-xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 border-l-4 border-transparent hover:border-primary p-2">
                  <div className="h-64 overflow-hidden relative">
                    <div
                      className="absolute inset-0 bg-cover bg-center group-hover:scale-105 transition-transform duration-500"
                ...
                <Link href="/search?category=marketing" className="group relative flex flex-col bg-white dark:bg-[#1E1E1E] rounded-xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 border-l-4 border-transparent hover:border-primary p-2">
                  <div className="h-64 overflow-hidden relative">
                    <div
                      className="absolute inset-0 bg-cover bg-center group-hover:scale-105 transition-transform duration-500"
