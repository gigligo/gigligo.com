                        ...
                        <div className="flex-1 overflow-y-auto">
                            {[...mainLinks, ...moreLinks].map(link => (
                                <Link
                                    key={link.label}
                                    href={link.href}
                                    className="block text-lg font-medium text-slate-700 dark:text-[#EFEEEA]/80 py-3 border-b border-slate-200 dark:border-white/10 hover:text-[#FE7743] transition-colors"
